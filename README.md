...
* After installation has finished you will have nginx installed on your machine; to configure nginx with a self signed certificate please follow this [link](https://github.com/lacchain/besu-network/blob/master/docs/files/SELFSIGNED_CERTIFICATE.md)
